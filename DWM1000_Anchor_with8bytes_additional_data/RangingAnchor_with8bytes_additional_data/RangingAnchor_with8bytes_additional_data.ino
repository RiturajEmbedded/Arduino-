...
float otherFloat1 = 0.00;
float otherFloat2 = 0.00;
    ...
    if (receivedAck) {
        ...
        if (msgId == POLL) {
            ...
            if (!protocolFailed) {
                ...
                memcpy(&otherFloat1,data+16,4);
                memcpy(&otherFloat2,data+20,4);
                Serial.print("Range: "); Serial.print(distance-0.60); Serial.print(" m");
                ...
                Serial.print("\t Sampling: "); Serial.print(samplingRate); Serial.println(" Hz");
                 Serial.print("Temperature "); Serial.print(otherFloat1); Serial.println(" Celcius");
                 Serial.print("Moisture"); Serial.print(otherFloat2); Serial.println("%");
